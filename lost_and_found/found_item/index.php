...
<html>
  ...
  <body>
    <header>
      ...
      <h2 id="moto">Did you find an item? please help us return it to the owner.</h2>
    </header>
...
<?php
    ...
    if(isset($_POST['finish'])){
      ...
      $ins_item = "insert into found_item (finder_email, item_name, item_image, item_desc1, item_desc2, item_desc3, item_desc4, item_location, item_state) values('$email', '$name', '$image', '$desc_1', '$desc_2', '$desc_3', '$desc_4', '$city', $state)";

      $run_ins = mysqli_query($con, $ins_item);

      if($run_ins){
        echo "<script>alert('Thanks for caring')</script>";
