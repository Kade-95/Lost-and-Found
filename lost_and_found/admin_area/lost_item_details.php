  ...
  <body>
    ...
    <div id="main_content">
      ...
      <?php
        ...
        $get_id = $_GET['lost_item'];
        $get_item = "select * from lost_item where lost_id='$get_id'";
        $run_get = mysqli_query($con, $get_item);
        $row_get = mysqli_fetch_array($run_get);

        if($row_get){
          $loser_email = $row_get['loser_email'];
       ...
       <img src='../lost_item/images/<?php echo $item_image;?>' width='400px' height='300px' />
       <p>Details</p>
       <p><?php echo $item_desc1;?></p>
       <p><?php echo $item_desc2;?></p>
       <p><?php echo $item_desc3;?></p>
       <p><?php echo $item_desc4;?></p>
